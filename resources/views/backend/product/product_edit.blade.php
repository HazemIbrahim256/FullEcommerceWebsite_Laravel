						...
						<div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
									...
									<div class="controls">
										<input type="text" value="{{$products->product_size_en}}" name="product_size_en" class="form-control" data-role="tagsinput" > 
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<div class="controls">
										<input value="{{$products->product_size_ar}}" data-role="tagsinput" type="text" name="product_size_ar" class="form-control" > 
		...
		<div class="col-md-12">
			<div class="box bt-3 border-info">
				...
				<form method="post" action="{{route('update.image')}}" enctype="multipart/form-data">
					...
					<div class="text-xs-right">
						<input type="submit" class="btn btn-rounded btn-primary mb-5" value="Update Product Images">
					</div>
					<br>
				</form>
