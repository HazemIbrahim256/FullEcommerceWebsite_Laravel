        ...
        <div class="box-body">
            <div class="table-responsive">
                ...
                <tbody>
                    ...
                    <tr>
                        <td width="30%">{{$item->division->division_name}}</td>

                        <td width="30%">{{$item->district_name}}</td>
                        
                        <td width="20%">
                            <a href="{{route('district.edit',$item->id)}}" class="btn btn-info" title="Edit"><i class="fa fa-pencil"></i> </a>
                            <a href="{{route('district.delete',$item->id)}}" class="btn btn-danger" title="Delete"><i class="fa fa-trash"></i> </a>
                        </td>
                    </tr>
            ...
            <div class="table-responsive">
                <form method="POST" action="{{route('district.store')}}">
                    ...
                    <div class="text-xs-right">
                        <input type="submit" class="btn btn-primary mb-5" value="Add District">
                    </div>
                </form>
            </div>
        </div>
