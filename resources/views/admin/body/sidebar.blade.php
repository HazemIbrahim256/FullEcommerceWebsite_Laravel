...
<section class="sidebar">	
    ...
    <li class="treeview {{($prefix == '/category')? 'active':''}}">
        ...
        <ul class="treeview-menu">
        <li class="{{($route == 'all.cats')? 'active':''}}"><a href="{{route('all.cats')}}"><i class="ti-more"></i>All Categories</a></li>
        <li class="{{($route == 'all.subcats')? 'active':''}}"><a href="{{route('all.subcats')}}"><i class="ti-more"></i>All Subcategories</a></li>
        <li class="{{($route == 'all.subsubcats')? 'active':''}}"><a href="{{route('all.subsubcats')}}"><i class="ti-more"></i>All Sub-Subcategories</a></li>
    ...
    <li class="treeview {{($prefix == '/products')? 'active':''}}">
        ...
        <li class="{{($route == 'mng.product')? 'active':''}}"><a href="{{route('mng.product')}}"><i class="ti-more"></i>Manage Products</a></li>
    ...
    <li class="treeview {{($prefix == '/slider')? 'active':''}}">
        ...
        <ul class="treeview-menu">
        <li class="{{($route == 'mng.slider')? 'active':''}}"><a href="{{route('mng.slider')}}"><i class="ti-more"></i>Manage Slider</a></li>
    ...
    <li class="treeview {{($prefix == '/coupons')? 'active':''}}">
        ...
        <ul class="treeview-menu">
        <li class="{{($route == 'mng.coupon')? 'active':''}}"><a href="{{route('mng.coupon')}}"><i class="ti-more"></i>Manage Coupons</a></li>
    ...
    <li class="treeview {{($prefix == '/shipping')? 'active':''}}">
        ...
        <ul class="treeview-menu">
        <li class="{{($route == 'mng.division')? 'active':''}}"><a href="{{route('mng.division')}}"><i class="ti-more"></i>Ship Division</a></li>
        
        <li class="{{($route == 'mng.district')? 'active':''}}"><a href="{{route('mng.district')}}"><i class="ti-more"></i>Ship District</a></li>

        <li class="{{($route == 'mng.state')? 'active':''}}"><a href="{{route('mng.state')}}"><i class="ti-more"></i>Ship State</a></li>
    ...
    <li class="treeview {{ ($prefix == '/reports')?'active':'' }}  ">
        ...
        <ul class="treeview-menu">
            <li class="{{ ($route == 'all-reports')? 'active':'' }}"><a href="{{ route('all-reports') }}"><i class="ti-more"></i>Reports</a></li>
