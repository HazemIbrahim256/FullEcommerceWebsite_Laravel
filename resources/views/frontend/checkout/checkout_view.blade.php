    ...
    <div class="panel-body">
        <div class="row">		
            ...
            <div class="col-md-6 col-sm-6 already-registered-login">
                <h4 class="checkout-subtitle"><strong>Shipping Address</strong></h4><hr>
            ...
            <div class="col-md-6 col-sm-6 already-registered-login">
                ...
                <div class="form-group">
                    ...
                    <textarea name="notes" class="form-control" id="" cols="30" rows="5" placeholder="Any Notes??"></textarea>
                </div>
        ...
        <div class="">
            <ul class="nav nav-checkout-progress list-unstyled">
                @foreach ($carts as $item)
                    <br>
                    <li><strong>Image: </strong><img src="{{asset($item->options->image)}}" style="height: 50px; width: 50px" alt=""></li> <br>
                    <li><strong>Quantity: </strong>({{$item->qty}})
                    <strong>Color: </strong>{{$item->options->color}}
                    <strong>Size: </strong>{{$item->options->size}}</li>
                ...
                <li>
                    ...
                    <strong>Coupon: </strong>{{session()->get('coupon')['coupon_name']}} ({{session()->get('coupon')['coupon_discount']}}%)<hr>
                    <strong>Discount: </strong>${{session()->get('coupon')['discount_amount']}}<hr>
